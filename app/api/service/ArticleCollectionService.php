...
use app\common\model\ArticleCollection;
use app\api\exception\ApiServiceException;
use think\db\exception\{DbException, ModelNotFoundException, DataNotFoundException};

class ArticleCollectionService extends ApiBaseService
{
    protected ArticleCollection $model;

    public function __construct()
    {
        $this->model = new ArticleCollection();
    }
    ...
    {
        try {
            $field = 'id,user_id,article_id,collection_status,create_time';
            $data  = $this->model
