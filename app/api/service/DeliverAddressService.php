...
class DeliverAddressService extends ApiBaseService
{
    protected DeliverAddress $model;

    public function __construct()
    {
        $this->model = new DeliverAddress();
    }
    ...
    {
        try {
            $field = 'id,user_id,name,mobile,province_id,city_id,district_id,street_id,detail,is_default,create_time';
            $data  = $this->model
