...
class StaffService extends ApiBaseService
{
    ...
    {
        try {
            $field = 'id,avatar,name,department_id,position_id,job_number,mobile,email,birthday,hired_date,is_boss,is_leader,sort_number,status,create_time';
            $data  = $this->model
