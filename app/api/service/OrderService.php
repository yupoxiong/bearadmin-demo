...
class OrderService extends ApiBaseService
{
    ...
    {
        try {
            $field = 'id,order_no,user_id,order_price,pay_price,goods_price,express_price,name,mobile,province_id,city_id,district_id,street_id,address,full_address,express_id,express_no,payment_id,pay_status,pay_time,deliver_status,deliver_time,receive_time,create_time';
            $data  = $this->model
