...
class StaffController extends AdminBaseController
{
     ...
     * @throws Exception
     */
    public function index(Request $request, Staff $model): string
    {
        $param = $request->param();
        $data  = $model->with(['department', 'position',])->scope('where', $param)
            ->paginate([
     ...
     * @return Json
     */
    public function del($id, Staff $model): Json
    {
