...
class PaymentController extends AdminBaseController
{
     ...
     * @throws Exception
     */
    public function index(Request $request, Payment $model): string
    {
        $param = $request->param();
     ...
     * @throws Exception
     */
    public function add(Request $request, Payment $model, PaymentValidate $validate)
    {
        if ($request->isPost()) {
            $param           = $request->param();
     ...
     * @throws Exception
     */
    public function edit($id, Request $request, Payment $model, PaymentValidate $validate)
    {
     ...
     * @return Json
     */
    public function del($id, Payment $model): Json
    {
