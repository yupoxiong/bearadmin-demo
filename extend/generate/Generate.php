...
class Generate
{
        ...
        $config_tmp            = [
            ...
            'template' => [
                ...
                'admin' => [
                    ...
                    'action_index_tree'  => $admin_controller_path . 'action_index_tree.stub',
                    ...
                    'action_del_tree'    => $admin_controller_path . 'action_del_tree.stub',
                ...
                'admin_view' => [
                    ...
                    'index_tree'               => $admin_view_path . 'index/index_tree.stub',
    ...
    public function getAllField($table_name): array
    {
        ...
        foreach ($field_list as $value) {
            ...
            if ($value['Field'] === 'id') {
                ...
                // 这里判断是否为关联外键
                $union_table = $this->getRelation($value['Field'], $table_name);
                if ($union_table) {
                    $relation_type = 2;
        ...
        foreach ($data['field'] as $key => $value) {
            ...
            $tree_show_list = ['id', 'name','parent_id'];
            if ($data['tree_show'] === 1 && !in_array($value['name'], $tree_show_list, true)) {
                $data['field'][$key]['list_sort'] = 0;
                $data['field'][$key]['is_list']   = 0;
                $data['field'][$key]['form_type'] = 'none';
            }

            if($data['tree_show'] === 1 && $value['name']==='parent_id'){
                $data['field'][$key]['is_list']   = 0;
            }
     ...
     * @return string
     */
    public function getRelation($field, $table): string
    {
        $result = '';
