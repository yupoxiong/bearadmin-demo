...
class Article extends Migrator
{
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('user_id', 'integer', ['signed' => false, 'limit' => 10, 'default' => 0, 'comment' => '发布人'])
            ->addColumn('article_category_id', 'integer', ['signed' => false, 'limit' => 10, 'default' => 0, 'comment' => '所属分类'])
            ...
            ->addColumn('is_hot', 'boolean', ['signed' => false, 'limit' => 1, 'default' => 0, 'comment' => '是否热门'])
            ...
            ->addColumn('view_count', 'integer', ['signed' => false, 'limit' => 10, 'default' => 0, 'comment' => '浏览数'])
            ->addColumn('create_time', 'integer', ['signed' => false, 'limit' => 10, 'default' => 0, 'comment' => '发布时间'])
