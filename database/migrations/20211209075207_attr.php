...
class Attr extends Migrator
{

    public function change()
    {
        $table = $this->table('attr', ['comment'=>'规格','engine' => 'InnoDB', 'encoding' => 'utf8mb4', 'collation' => 'utf8mb4_unicode_ci']);
        $table
            ->addColumn('attr_group_id', 'integer', ['signed' => false,'limit' => 10, 'default' => 0, 'comment' => '所属规格组'])
