...
class OrderGoods extends Migrator
{
    ...
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('attr', 'string', ['limit' => 500, 'default' => '', 'comment' => '规格'])
            ->addColumn('price', 'decimal', ['signed' => false,'precision' => 14, 'scale' => 2, 'default' => 0, 'comment' => '单价'])
            ->addColumn('total_price', 'decimal', ['signed' => false,'precision' => 14, 'scale' => 2, 'default' => 0, 'comment' => '总价'])
