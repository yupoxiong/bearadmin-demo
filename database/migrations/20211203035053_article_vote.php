...
class ArticleVote extends Migrator
{

    public function change()
    {
        $table = $this->table('article_vote', ['comment'=>'文章点赞','engine' => 'InnoDB', 'encoding' => 'utf8mb4', 'collation' => 'utf8mb4_unicode_ci']);
        $table
            ...
            ->addColumn('vote_status', 'boolean', ['signed' => false, 'limit' => 1, 'default' => 1, 'comment' => '点赞状态'])
