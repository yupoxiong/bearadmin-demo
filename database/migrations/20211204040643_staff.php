...
class Staff extends Migrator
{
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('department_id', 'integer', ['signed' => false, 'limit' => 10, 'default' => 0, 'comment' => '部门'])
            ->addColumn('position_id', 'integer', ['signed' => false, 'limit' => 10, 'default' => 0, 'comment' => '职位'])
            ->addColumn('job_number', 'integer', ['signed' => false, 'limit' => 10, 'default' => 0, 'comment' => '工号'])
            ...
            ->addColumn('is_boss', 'boolean', ['signed' => false, 'limit' => 1, 'default' => 0, 'comment' => '是否为老板'])
            ->addColumn('is_leader', 'boolean', ['signed' => false, 'limit' => 1, 'default' => 0, 'comment' => '是否所属部门领导'])
